...
distance_list = [50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350]
SG1 = SG2 = SG3 = SG4 = SG5 = SG6 = SG7 = SG8 = SG9 = SG10 = SG11 = SG12 = pd.DataFrame(columns = ['date', 'Strokes Gained Approach'])
sgapproach_list = [SG1, SG2, SG3, SG4, SG5, SG6, SG7, SG8, SG9, SG10, SG11, SG12]
...
n = 0
print(sgapproach_list)
for df in sgapproach_list:
	SGaverage = df.loc[:,'Strokes Gained Approach'].mean()
	print(df)
	print(SGaverage, "cool")
